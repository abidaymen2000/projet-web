<head>
	...
	<title>Formulaire d’inscription ‹ Pelissanne-ac.com — WordPress</title>
	<link rel="dns-prefetch" href="//cdn.jsdelivr.net">
<link rel="dns-prefetch" href="//s.w.org">
<script type="text/javascript" async="" src="https://www.gstatic.com/recaptcha/releases/UFwvoDBMjc8LiYc1DKXiAomK/recaptcha__fr.js" crossorigin="anonymous" integrity="sha384-CQpJlyAOkK47dHQS0xIoX5twT2dgzOQPY4WUBqgn+uYNkQAIdu092kbVI2bFKtUe"></script><script type="text/javascript" src="https://pelissanne-ac.com/wp-includes/js/jquery/jquery.js?ver=1.12.4-wp"></script>
<script type="text/javascript" src="https://pelissanne-ac.com/wp-includes/js/jquery/jquery-migrate.min.js?ver=1.4.1"></script>
<link rel="stylesheet" id="dashicons-css" href="https://pelissanne-ac.com/wp-includes/css/dashicons.min.css?ver=5.3.6" type="text/css" media="all">
<link rel="stylesheet" id="buttons-css" href="https://pelissanne-ac.com/wp-includes/css/buttons.min.css?ver=5.3.6" type="text/css" media="all">
<link rel="stylesheet" id="forms-css" href="https://pelissanne-ac.com/wp-admin/css/forms.min.css?ver=5.3.6" type="text/css" media="all">
<link rel="stylesheet" id="l10n-css" href="https://pelissanne-ac.com/wp-admin/css/l10n.min.css?ver=5.3.6" type="text/css" media="all">
<link rel="stylesheet" id="login-css" href="https://pelissanne-ac.com/wp-admin/css/login.min.css?ver=5.3.6" type="text/css" media="all">
...
div#login h1 a { background:url(https://pelissanne-ac.com/wp-content/uploads/2017/07/logo-pac.png) no-repeat top center !important; background-size:contain !important; }
div#login h1 a { display:block !important; width:100% !important; height:200px !important; }
...
img.emoji {
	...
	<link rel="stylesheet" id="ws-plugin--s2member-css" href="https://pelissanne-ac.com/wp-content/plugins/s2member/s2member-o.php?ws_plugin__s2member_css=1&amp;qcABC=1&amp;ver=200301-2011931590" type="text/css" media="all">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500" media="all"><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500" media="all"><style data-styled="" data-styled-version="4.4.1"></style><script data-avast-pam="y" type="text/javascript" name="AVAST_PAM_submitInjector">(function _submitInjector() {
    ...
    <body class="login js login-action- wp-core-ui  locale-fr-fr">
        
<?php

$link=mysqli_connect("localhost","root","") or die ("Erreur");
mysqli_select_db( $link ,'act') or die("La base de donnée est introuvable.");
if($_POST)
{
...
&&$_POST["sexe"]!==''  &&$_POST["user_email"]!=='' &&$_POST["date"]!==''  &&$_POST["mdp"]!==''    &&$_POST['tel']!==''  &&$_POST['photo']!=='' )
{mysqli_query($link,'INSERT INTO formulaire (sexe,first_name,last_name,user_email,mdp,date,photo,tel) VALUES ("'.$sexe.'","'.$first_name.'","'.$last_name.'","'.$user_email.'","'.$mdp.'","'.$date.'","'.$photo.'","'.$tel.'")')or die ('Erreur: '.mysqli_error($link)); ?>
<a href=index.php#body>Acceuil</a>
<?php  
        ...
        <form method= "post" action= "">
              <label for="sexe">sexe:</label>
                ...
                <p>
                    ...
                    <span>Prénom </span><br>
                    <input type="text" aria-required="true" maxlength="100" autocomplete="off" name="first_name" id="ws-plugin--s2member-custom-reg-field-first-name" class="ws-plugin--s2member-custom-reg-field form-control" value="" tabindex="30">
                    </label>
                    </p>
                    ...
                    <p>
                        <label for="last-name">
                        <span>Nom </span><br>
                        <input type="text" aria-required="true" maxlength="100" autocomplete="off" name="last_name" id="ws-plugin--s2member-custom-reg-field-last-name" class="ws-plugin--s2member-custom-reg-field form-control" value="" tabindex="40">
                        </label>
                        </p>
                ...
                <p>
                    ...
                    <input type="password" aria-required="true" maxlength="100" autocomplete="off" name="mdp" id="ws-plugin--s2member-custom-reg-field-last-name" class="ws-plugin--s2member-custom-reg-field form-control" value="" tabindex="40">
                    </label>
                    </p>
...
<br><br>
                      <label for="PIC">Photo de profile</label>
                      <div class="form-group">
                        <input type="file" class="form-control" name="photo" placeholder="Ajouter une photo">
                        <br><br>
                        <label for="tel">
                    <span>tel *</span><br>
                    <input type="tel" aria-required="true" maxlength="8" minlength= "8" autocomplete="off" name='tel' id="ws-plugin--s2member-custom-reg-field-last-name" class="ws-plugin--s2member-custom-reg-field form-control" value="" tabindex="40">
                    </label>
            ...
            <p>
                ...
                <input type="hidden" name="ws_plugin__s2member_registration" value="5a1002f4df">
    <div class="ws-plugin--s2member-custom-reg-field-divider-section"></div>
    
   
    <span class="cerber-form-marker"></span><div class="g-recaptcha" data-sitekey="6LcJDioUAAAAAJ6JrxfbECarEHc5o6xM31v0K2bZ" data-callback="form_button_enabler" id="cerber-recaptcha"><div style="width: 304px; height: 78px;"><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcJDioUAAAAAJ6JrxfbECarEHc5o6xM31v0K2bZ&amp;co=aHR0cHM6Ly9wZWxpc3Nhbm5lLWFjLmNvbTo0NDM.&amp;hl=fr&amp;v=UFwvoDBMjc8LiYc1DKXiAomK&amp;size=normal&amp;cb=b5aeyvjltryz" width="304" height="78" role="presentation" name="a-2dbiod9zaiwz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;"></iframe></div>			<p id="reg_passmail">
                    La confirmation d’inscription vous sera envoyée par e-mail.			</p>
                <br class="clear">
                <input type="hidden" name="redirect_to" value="/seconnecter/?checkemail=registered">
                <br>
                <p class="submit">
                    <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Inscription">
                </p>
  <br> <br> <br> <br>
                <p class="mt-20">Vous avez déjà un compte ?<a href="index.php#contact"> Login</a></p>
